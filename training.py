...
# ==========================================
# ARGUMENT PARSER - replaces hardcoded paths
# ==========================================
def parse_args():
    parser = argparse.ArgumentParser(description="Unified PSCDL Net - Training Pipeline")
    parser.add_argument('--data_dir', type=str, default='data',
                        help='Path to dataset folder containing t0/, t1/, mask/ subdirs')
...
if __name__ == '__main__':
    ...
    full_dataset = LocalPSCDLDataset(base_dir=args.data_dir, img_size=(args.img_size, args.img_size))
    ...
    if len(full_dataset) > 0:
        ...
        for epoch in range(args.epochs):
            ...
            if epoch_val_loss < best_val_loss:
                ...
                checkpoint_path = os.path.join(args.checkpoint_dir, "best_pscdl_model.pth")
                torch.save({
                    'epoch': epoch + 1,
